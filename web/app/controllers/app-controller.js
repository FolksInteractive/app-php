(function(ng, tcApp){
    tcApp.controller(
        "AppController",
        function( $rootScope, $scope, $route, $routeParams, $location, requestContext){
            ...
            $scope.windowTitle = "TimeCrumbs";

            // The subview indicates which view is going to be rendered on the page.
            $scope.subview = renderContext.getNextSection( );
            // Store the Router reference
            //$scope.Router = Router;
            ...
            $scope.$on(
                ...
                function(event){
                    ...
                    $rootScope.$broadcast("requestContextChanged", requestContext);
                }
            );
            // --- Initialize. ---------------------------------- //
